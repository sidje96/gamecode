...
# This is a common python method at the end of the code to easily execute it,
# but only when running the file directly not when importing it from another file.
